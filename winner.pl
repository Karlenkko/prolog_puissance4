...
winDiagLeft(Index, Board, Piece, Number, Result) :- Index < 7,nth0(Index, Board, Val),Val == Piece, Result = Number,!.
winDiagLeft(Index, Board, Piece, Number, Result) :- (Index mod 7) =:= 0,nth0(Index, Board, Val),Val == Piece, Result = Number, !.
winDiagLeft(Index, Board, Piece, Number, Result) :- Index < 7, Result is Number-1,!.
...
winDiagRight(Index, Board, Piece, Number, Result) :- Index > 33, nth0(Index, Board, Val),Val == Piece, Result = Number,!.
winDiagRight(Index, Board, Piece, Number, Result) :- (Index mod 7) =:= 6,nth0(Index, Board, Val),Val == Piece, Result = Number, !.
winDiagRight(Index, Board, Piece, Number, Result) :- Index > 33, Result is Number-1,!.
...
winRDiagLeft(Index, Board, Piece, Number, Result) :- Index > 35,nth0(Index, Board, Val),Val == Piece, Result = Number, !.
winRDiagLeft(Index, Board, Piece, Number, Result) :- (Index mod 7) =:= 0,nth0(Index, Board, Val), Val == Piece, Result = Number, !.
winRDiagLeft(Index, Board, Piece, Number, Result) :- Index > 35, Result is Number-1, !.
...
winRDiagRight(Index, Board, Piece, Number, Result) :- Index < 6,nth0(Index, Board, Val),Val == Piece, Result = Number, !.
winRDiagRight(Index, Board, Piece, Number, Result) :- (Index mod 7) =:= 6, nth0(Index, Board, Val),Val == Piece, Result = Number, !.
winRDiagRight(Index, Board, Piece, Number, Result) :- Index < 6, Result is Number-1, !.
